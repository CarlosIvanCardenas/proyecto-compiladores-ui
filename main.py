...
def main():
    if DEBUG_UI:
        ...
        #input_file = open("examples/factorial_iterative.txt", "r")
        #input_file = open("examples/factorial_recursive.txt", "r")
        ...
        #input_file = open("examples/fibonacci_iterative.txt", "r")
